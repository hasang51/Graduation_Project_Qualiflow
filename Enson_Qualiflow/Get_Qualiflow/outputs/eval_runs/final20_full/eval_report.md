...
- predictions: `data\batch_runs\final20_full\per_document`
...
| n_documents | 20 |
| field_accuracy | 0.6 |
| critical_field_accuracy | 0.6786 |
| document_type_accuracy | 0.7 |
| processing_decision_accuracy | 0.0 |
| review_rate | 1.0 |
| unsafe_auto_accept_rate | 0.0 |
| missing_required_field_rate | 0.0714 |
| average_latency_ms | 37380.3 |
