...
- predictions: `data\batch_runs\final20\per_document`
...
| --- | --- |
| n_documents | 20 |
| field_accuracy | 0.1476 |
| critical_field_accuracy | 0.1696 |
| document_type_accuracy | 0.2 |
| processing_decision_accuracy | 0.0 |
| review_rate | 1.0 |
| unsafe_auto_accept_rate | 0.0 |
| missing_required_field_rate | 0.75 |
| average_latency_ms | 37662.7 |
